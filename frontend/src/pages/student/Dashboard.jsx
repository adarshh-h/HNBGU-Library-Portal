              ...
              <div key={b.issuedBookId || b._id}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 w-full">
                    <div>
                      <p className="font-semibold" style={{color:"var(--text-primary)"}}>{b.bookName}</p>
                      <p className="text-sm mt-0.5" style={{color:"var(--text-muted)"}}>{b.authorName}</p>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-3 text-xs" style={{color:"var(--text-muted)"}}>
                    ...
                    <span className="font-mono px-2 py-0.5 rounded" style={{background:"var(--bg-surface-3)",color:"var(--text-primary)",border:"1px solid var(--border)"}}>{b.accessionNumber}</span>
                  </div>
                </div>
              </div>
            )
