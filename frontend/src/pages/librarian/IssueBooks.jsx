  ...
  if (success) return (
    <div className="animate-in page-container page-container--workflow">
      <div className="py-8 sm:py-12">
        ...
        <h2 className="font-serif text-2xl font-semibold mb-2" style={{color:"var(--text-primary)"}}>Books issued successfully!</h2>
  ...
  return (
    <div className="animate-in page-container page-container--workflow">
      ...
      <div className="card p-4 sm:p-6 mb-4">
        <h3 className="font-serif font-semibold mb-4 flex items-center gap-2 text-sm sm:text-base" style={{color:"var(--text-primary)"}}>
          ...
          <div className="mt-3 space-y-2">
            {books.map(b => (
              <div key={b._id} className="flex items-center gap-3 p-2.5 rounded-lg bg-neutral-50 border border-neutral-100">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium truncate" style={{color:"var(--text-primary)"}}>{b.bookName}</p>
                  <p className="text-xs" style={{color:"var(--text-muted)"}}>{b.accessionNumber} · {b.authorName}</p>
                </div>
      ...
      {/* Step 3: Dates */}
      <div className="card p-4 sm:p-6 mb-4">
        <h3 className="font-serif font-semibold mb-4" style={{color:"var(--text-primary)"}}>Step 3 — Set dates</h3>
