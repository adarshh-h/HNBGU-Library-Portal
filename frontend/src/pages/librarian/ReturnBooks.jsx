  ...
  return (
    <div className="animate-in page-container page-container--workflow">
      ...
      <div className="card p-4 sm:p-6 mb-4">
        <h3 className="font-serif font-semibold mb-4 flex items-center gap-2" style={{color:"var(--text-primary)"}}>
      ...
      {student && (
        <div className="card overflow-hidden">
          <div className="panel-header">
            <h3 className="font-serif font-semibold text-base" style={{color:"var(--text-primary)"}}>Issued books</h3>
                  ...
                  <div key={b.issuedBookId} className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 px-4 sm:px-6 py-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs" style={{color:"var(--text-muted)"}}>Due: {formatDate(b.dueDate)}</span>
