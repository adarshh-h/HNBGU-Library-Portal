...
//             <span className="text-xl font-semibold text-gray-800">Library System</span>
//           </Link>
//           <nav className="space-x-4">
//             <Link to="/librarian-login" className="text-blue-600 hover:underline">Librarian Login</Link>
//             <Link to="/student-login" className="text-green-600 hover:underline">Student Login</Link>
//           </nav>
//         </div>
//       </header>
