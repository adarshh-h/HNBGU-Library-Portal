...
//   <button
//     onClick={onClick}
//     className={`flex flex-col items-center justify-center text-white rounded-xl shadow-md transition-all duration-200 p-5 ${color} hover:shadow-lg hover:-translate-y-1`}
//     aria-label={title}
//   >
//     <div className="mb-3 p-3 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
